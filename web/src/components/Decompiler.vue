<template>
  <div>
    ...
    <div
      v-else
      style="position: absolute; overflow: scroll; top: 34px; bottom:0px; left: 0px; right: 0px; font-size:12px;"
    >
      <div v-if="decompiledResults">
        <pre v-highlightjs="decompiledResults.source"><code class="cpp" /></pre>
      </div>
      <div v-else>
