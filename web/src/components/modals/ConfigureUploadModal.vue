    ...
    >
      <div v-if="loading">
        <div class="card bg-light mb-3">
          <div class="card-body">
            <h5 class="card-title">
              <i class="fa fa-spinner fa-spin" /> Processing Your File Upload ...
            </h5>
            <p class="card-text">
              Processing files can take a minute, <strong>especially for ida imports</strong>.
              You'll be redirected once the import is complete.
            </p>
          </div>
        </div>
      </div>
      <div v-else>
        <div v-if="binaryOptions">
          <div class="alert alert-success">
            ...
            <ul>
              <li v-for="f in fileData.file_format">
                {{ f }}
              </li>
            </ul>
            <br>
